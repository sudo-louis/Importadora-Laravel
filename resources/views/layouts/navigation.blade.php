<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if($canContenedores)
                        <x-nav-link :href="route('contenedores.index')" :active="request()->routeIs('contenedores.*')">
                            {{ __('Contenedores') }}
                        </x-nav-link>
                    @endif
                    ...
                    @if($canActividad)
                        <x-nav-link :href="route('actividad.contenedores')" :active="request()->routeIs('actividad.*')">
                            {{ __('Actividad') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if($canContenedores)
                <x-responsive-nav-link :href="route('contenedores.index')" :active="request()->routeIs('contenedores.*')">
                    {{ __('Contenedores') }}
                </x-responsive-nav-link>
            @endif
            ...
            @if($canActividad)
                <x-responsive-nav-link :href="route('actividad.contenedores')" :active="request()->routeIs('actividad.*')">
                    {{ __('Actividad') }}
                </x-responsive-nav-link>
            @endif
